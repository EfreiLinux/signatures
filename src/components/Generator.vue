    ...
    <form class="form-horizontal">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10">
            <input class="form-control" id="inputEmail" placeholder="john.doe@efrei-linux.fr" type="text" v-model="inputEmail" v-on:focus="showMail()">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10">
            <input class="form-control" id="inputPhone" placeholder="01 23 45 67 89" type="text" v-model="inputPhone" v-on:focus="showPhone()">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10">
            <input class="form-control" id="inputRole" placeholder="Membre" type="text" v-model="inputRole" v-on:focus="showRole()">
          </div>
        </div>
      ...
      <div class="panel-body" id="signature">
        ...
        <div style="margin-top:0px; margin-left: 110px">
          <p style="font-family: Helvetica, sans-serif; font-size: 12px; line-height: 14px; color: #333; margin-top:0; margin-left:0; padding-left:0;">
            ...
            <span v-if="displayRole">/ {{ inputRole }} Efrei-Linux</span>
            <span v-else>/ Membre Efrei-Linux</span><br>
            <span v-if="displayMail"> <a v-bind:href="'mailto:' +  inputEmail" style="color:#3684c8;">{{ inputEmail }}</a></span>
            <span v-else><a href="mailto:john.doe@efrei-linux.fr" style="color:#3684c8;">john.doe@efrei-linux.fr</a></span><br>
            <span v-if="displayPhone">{{ inputPhone }}</span>
            <span v-else>01 23 45 67 89</span>
          </p>
          <p style="font-family: Helvetica, sans-serif; font-size: 12px; line-height: 14px; color: rgb(51, 51, 51); margin-top: 0px;">
            <span><a href="https://efrei-linux.fr" style="color:#3684c8;" rel="nofollow" target="_blank">https://efrei-linux.fr</a></span> <br>
          </p>
        </div>
      </div>
    </div>
